...
// source: icademo/interchainquery/tx.proto
...
func (*MsgSubmitQueryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f515d9d5d66408e0, []int{0}
}
...
func (*MsgSubmitQueryResponseResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f515d9d5d66408e0, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgSubmitQueryResponse)(nil), "icademo.interchainquery.MsgSubmitQueryResponse")
	proto.RegisterType((*MsgSubmitQueryResponseResponse)(nil), "icademo.interchainquery.MsgSubmitQueryResponseResponse")
}

func init() { proto.RegisterFile("icademo/interchainquery/tx.proto", fileDescriptor_f515d9d5d66408e0) }

var fileDescriptor_f515d9d5d66408e0 = []byte{
	// 506 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *msgClient) SubmitQueryResponse(ctx context.Context, in *MsgSubmitQueryResponse, opts ...grpc.CallOption) (*MsgSubmitQueryResponseResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/icademo.interchainquery.Msg/SubmitQueryResponse", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_SubmitQueryResponse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/icademo.interchainquery.Msg/SubmitQueryResponse",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "icademo.interchainquery.Msg",
	...
	Metadata: "icademo/interchainquery/tx.proto",
}
