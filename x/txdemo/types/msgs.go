...
import (
	...
	"github.com/ThanhNhann/icademo/utils"
...
const (
	TypeMsgRegisterAccount  = "resgister_account"
	TypeMsgSubmitTx         = "submit_tx"
	TypeMsgRegisterHostZone = "register_host_zone"
	TypeMsgAddValidators    = "add_validators"
)
